...
<form:form modelAttribute="labTestType" id="testTypeForm" onsubmit='return validate(this);'>
    <!-- Concept Reference -->
    <div class="row">
        <div class="col-md-2">
            <form:input path="labTestTypeId" hidden="true" id="labTestTypeId"></form:input>
            <form:label class="control-label" path="referenceConcept.conceptId">
                <spring:message code="general.referenceConcept" />
                <span class="text-danger font-weight-bold">*</span>
            </form:label>
        </div>
        <div class="col-md-6">
            <form:input id="conceptSuggestBox" path="referenceConcept.conceptId"
