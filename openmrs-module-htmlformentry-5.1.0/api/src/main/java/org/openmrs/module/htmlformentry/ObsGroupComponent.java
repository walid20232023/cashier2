...
public class ObsGroupComponent {
	...
	private static void addToObsGroupComponentList(List<ObsGroupComponent> list, Concept question, Concept answer,
		...
		//Debut test
		/**
		 * if (list != null) { for (ObsGroupComponent component : list) { System.out.println("Question: " +
		 * component.getQuestion().getName()); System.out.println("Answer: " +
		 * component.getAnswer().getName()); if (component.getAnswerDrug() != null) {
		 * System.out.println("Drug: " + component.getAnswerDrug().getName()); } System.out.println("Is Part
		 * Of Set: " + component.isPartOfSet()); System.out.println("Is Last In Set: " +
		 * component.isLastInSet()); System.out.println("------------"); } } else { System.out.println("La
		 * liste est nulle"); }
		 **/
		...
		if (answer != null) {
			System.out.println("Reponse :" + answer.getName());
		} else {
